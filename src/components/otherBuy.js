...
export default function LandSelling(){
  ...
  if(types === '' || types === 'All'){
      ...
      useEffect(() => {
          axios.get("http://localhost:8075/advertising/searchOtherAll/"+type)
        ...
        // eslint-disable-next-line react-hooks/rules-of-hooks
        useEffect(() => {
          axios.get("http://localhost:8075/advertising/searchOtherAllPrice/"+type+"/"+min+"/"+max)
          .then(res => setOther(res.data))
          .catch(error => console.log(error));
      })
  }else{
   ...
   // eslint-disable-next-line react-hooks/rules-of-hooks
        useEffect(() => {
          axios.get("http://localhost:8075/advertising/searchOtherAlldiscrict/"+type+"/"+discrict)
          .then(res => setOther(res.data))
          .catch(error => console.log(error));
      }) 
    }
                ...
                <MDBCol>
                  <MDBCard>
                    <MDBCardBody>
                      ...
                      <MDBCardText>
                        <i class="fas fa-dollar-sign"></i> {Other.price}
                      </MDBCardText>
                      <MDBCardText>
