...
export default function ProfileEdit(){
      ...
      useEffect(() => {
          axios.get("http://localhost:8075/systemUser/searchUserProfile/"+nic)
      ...
      {users.map((user,key) => (
        <MDBCardBody>
          ...
          <div className="text-end">
              <Link  onClick={() => editProfile(user.name , user.tel, user.email, user.address , user.district)} /*to={"/EditProfile"}*/ className="text-white"> <MDBBtn href='#'>Edit <i class="fas fa-edit"></i></MDBBtn></Link>
          </div>   
        </MDBCardBody>
         ))};
      </MDBCard>
      </center>
      <MDBCardTitle className="fs-2 text-uppercase fw-normal text-center pb-3 pt-5 mt-5">Publish Advertisements </MDBCardTitle>
        ...
        <MDBCard className='h-100' style={{backgroundColor:'#CFD8DC'}}>
          ...
          <MDBCardBody>
             ...
             <MDBBtn className='mx-2 fw-light' color='dark' style={{letterSpacing:'2px'}}>
                <a href="/RealState?id=Real State" className="text-white"><i class="fas fa-bullseye"></i> Real State</a>
             </MDBBtn>
            </div>
          </MDBCardBody>
        </MDBCard>
      ...
      <MDBCol>
        <MDBCard className='h-100 ' style={{backgroundColor:'#CFD8DC'}}>
          ...
          <MDBCardBody>
            <div class="d-grid">
             <MDBBtn className='mx-2 fw-light' color='dark' style={{letterSpacing:'2px'}}>
                 <a href="/House?id=Houses" className="text-white"><i class="fas fa-bullseye"></i> Houses</a>
             </MDBBtn>
            </div>
          </MDBCardBody>
        </MDBCard>
      ...
      <MDBCol>
        <MDBCard className='h-100'  style={{backgroundColor:'#CFD8DC'}}>
          ...
          <MDBCardBody>
            <div class="d-grid">
             <MDBBtn className='mx-2 fw-light' color='dark' style={{letterSpacing:'2px'}}>
                <a href="/Appartment?id=Appartment" className="text-white"><i class="fas fa-bullseye"></i> Apartment</a>
             </MDBBtn>
            </div>
          </MDBCardBody>
        </MDBCard>
      ...
      <MDBCol>
        <MDBCard className='h-100' style={{backgroundColor:'#CFD8DC'}}>
          ...
          <MDBCardBody>
            <div class="d-grid">
             <MDBBtn className='mx-2 fw-light' color='dark' style={{letterSpacing:'2px'}}>
                <a href="/BussinessPlaces?id=Bussiness Places" className="text-white"><i class="fas fa-bullseye"></i> Bussiness Places</a>
             </MDBBtn>
            </div>
          </MDBCardBody>
        </MDBCard>
      ...
      <MDBCol>
        <MDBCard className='h-100' style={{backgroundColor:'#CFD8DC'}}>
          ...
          <MDBCardBody>
            <div class="d-grid">
             <MDBBtn className='mx-2 fw-light' color='dark' style={{letterSpacing:'2px'}}>
                <a href="/Bording?id=Bording" className="text-white"><i class="fas fa-bullseye"></i> Boarding Rooms</a>
             </MDBBtn>
            </div>
          </MDBCardBody>
        </MDBCard>
      ...
      <MDBCol>
        <MDBCard className='h-100' style={{backgroundColor:'#CFD8DC'}}>
          ...
          <MDBCardBody>
            <div class="d-grid">
             <MDBBtn className='mx-2 fw-light' color='dark' style={{letterSpacing:'2px'}}>
                 <a href="/LandSelling" className="text-white"><i class="fas fa-bullseye"></i> Land Sell </a>
             </MDBBtn>
            </div>
          </MDBCardBody>
        </MDBCard>
