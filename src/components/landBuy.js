...
export default function LandSelling(){
  ...
  if(type === '' || type === 'All'){
      // eslint-disable-next-line react-hooks/rules-of-hooks
            useEffect(() => {
                axios.get("http://localhost:8075/advertising/searchLandAll")
        ...
        // eslint-disable-next-line react-hooks/rules-of-hooks
        useEffect(() => {
          axios.get("http://localhost:8075/advertising/searchLandAllByPrice/"+min+"/"+max)
          .then(res => setLand(res.data))
          .catch(error => console.log(error));
      })
  }else{
   // eslint-disable-next-line react-hooks/rules-of-hooks
        useEffect(() => {
          axios.get("http://localhost:8075/advertising/searchLandAllByDistrict/"+discrict)
          .then(res => setLand(res.data))
          .catch(error => console.log(error));
      }) 
  }
